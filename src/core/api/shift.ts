...
export const shiftsApi = {
  ...
  openShift: (data: { opening_cash: string; opening_comment: string; store: number; register_id: number }) => api.post<Shift>(OPEN_SHIFT_URL, data),
  getSummary: (id: number) => api.get<ShiftSummary>(`${BASE_URL}${id}/summary/`),
  closeShift: (id: number, data: CloseShiftData) => api.post<Shift>(`${BASE_URL}${id}/close/`, data),
};
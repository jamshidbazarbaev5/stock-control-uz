...
//                   }}
//                 >
//                   <SelectTrigger className={form.formState.errors.store ? "border-red-500" : ""}>
...
//                       >
//                         <SelectTrigger className={form.formState.errors.sale_items?.[index]?.stock ? "border-red-500" : ""}>
...
//                         </SelectContent>
//                       </Select>
//                       {form.formState.errors.sale_items?.[index]?.stock && (
//                         <p className="text-sm text-red-500 mt-1">{form.formState.errors.sale_items[index].stock?.message}</p>
//                       )}
//                     </FormItem>
//                   )}
//                 />
